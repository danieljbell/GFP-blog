        ...
        <?php          
            if (is_tax()) {
              ...
              // else : 
                ...
                if ($diagramLink) {
                  echo '<div class="box--with-header mar-b--most" style="display: table; width: 100%;"><div style="display: table-cell; vertical-align: middle;"><img src="/wp-content/themes/gfp/dist/img/cogs.svg" alt="" style="max-width: 75px; width: 100%;"></div><div style="display: table-cell; vertical-align: middle;"><h4>Need A Detailed Parts Diagram?</h4><p><a href="' . $diagramLink . '">View the Diagram</a></p></div></div>';
                }
