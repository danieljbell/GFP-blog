    ...
    <div class="<?php echo esc_attr( implode( ' ', array_map( 'sanitize_html_class', $wrapper_classes ) ) ); ?>" data-columns="<?php echo esc_attr( $columns ); ?>" style="opacity: 0; transition: opacity .25s ease-in-out;">
      <figure class="woocommerce-product-gallery__wrapper">
        ...
        if ( has_post_thumbnail() ) {
          ...
          // print_r();
         echo '<a href="https://res.cloudinary.com/greenfarmparts/image/upload/fl_tiled,l_overlay,o_10/w_400/' . $product->get_sku() . '-0.jpg" data-modal-launch="display-product-image"><img src="https://res.cloudinary.com/greenfarmparts/image/fetch/fl_tiled,l_overlay,o_10/w_400/' . str_replace('gfp.local', 'greenfarmparts.com', wp_get_attachment_image_url($post_thumbnail_id, 'full')) . '" class="wp-post-image" alt="' . $product->get_sku() . '-0" title="' . $product->get_sku() . '-0.jpg"></a>';
        } else {
